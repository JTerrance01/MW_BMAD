...
namespace MixWarz.Infrastructure.Migrations
{
    ...
    [Migration("20250815152048_InitialHybridTournamentModels")]
    partial class InitialHybridTournamentModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MixWarz.Domain.Entities.Competition", b =>
                {
                    ...
                    b.Property<int>("Round1AdvancementCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MixWarz.Domain.Entities.FeedbackRating", b =>
                {
                    ...
                    b.HasIndex("JudgementId", "RaterUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("MixWarz.Domain.Entities.Judgement", b =>
                {
                    ...
                    b.HasIndex("SubmissionId", "JudgeUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("MixWarz.Domain.Entities.FeedbackRating", b =>
                {
                    ...
                    b.HasOne("MixWarz.Domain.Entities.User", "Rater")
                        .WithMany()
